...
style={styles.dropdown}
    ...
    />
                ...
                <View style={{}}>
                    ...
                    <View style={{}}>
                        <Text style={styles.textreason}>Name:</Text>
                        <View style={styles.view7}>
                            <TextInput style={styles.inputreason} placeholder="" />
                        </View>
                    </View>
                    ...
                    <View style={styles.view4}>
                        <View style={styles.view8}>
                            <Text style={styles.textreason}>Place:</Text>
                            <View style={{ marginBottom: 10 }}>
                                <TextInput style={styles.inputplace} placeholder=""
                                />
                            </View>
                            <Text style={{ marginLeft: 2, fontWeight: "bold" }}>Description:</Text>
                    ...
                    <View style={{ marginTop: 2 }}>
                        <Text style={{ marginLeft: 25, fontWeight: "bold" }}>Link:</Text>
                        <View style={{ justifyContent: "center", alignItems: "center" }}>
                            <TextInput style={styles.inputreason} placeholder="" onChangeText={(suggetion) => setSuggetion(suggetion)} />
                        </View>
                    </View>
                    <View style={{ marginTop: 10 }}>
                        <View >
                            <Text style={styles.textattachment}>File Upload:</Text>
                    ...
                    <View style={styles.view5}>
                        <View style={styles.view6}>
                            <TouchableOpacity style={styles.TouchableOpacity1}>
                                <Text style={{ color: "white", textAlign: "center" }}>Save Details</Text>
                            </TouchableOpacity>
                        </View>
                        <View style={styles.view9}>
                            ...
                            >
                                ...
                                <Text style={{ color: "white", textAlign: "center" }} onPress={() => handleSubmitButton()}>Cancel</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </View>
